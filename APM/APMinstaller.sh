...
#####################################################################################
#                                                                                   #
# * Ubuntu APMinstaller v.2.0.0-beta                                                    #
# * Ubuntu 22.04.02 LTS (IONOS server)                                                     #
# * Apache 2.4.X , MariaDB 10.10.X, Multi-PHP(base php7.4) setup shell script        #
